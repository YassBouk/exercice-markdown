...
```> Tous seul on va plus vite, ensemble on va plus loin``` > Tous seul on va plus vite, ensemble on va plus loin
...
```[OpenClassRoom](https://openclassrooms.com/fr/courses/1304236-redigez-en-markdown) ```
